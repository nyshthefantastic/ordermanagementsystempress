...
public class paymentAddition extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Brand Name", "Person Name", "Total", "Advance", "paid Amount", "Remaining amount", "reference Id", "Order Date"
            }
        ));
        ...
        jScrollPane1.setBounds(128, 345, 936, 402);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel1.setText("SEARCH");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(130, 270, 97, 29);
        ...
        searchText.setBounds(250, 270, 250, 40);
        ...
        jButton3.setBounds(990, 30, 61, 50);
    ...
    private void initab() {
        pt = new populateTable();
        sql = "select id,brandName,personName,total,advance,paidAmt,remainingamt,refId,orderDate from companyorders where  paymentStatus='" + "null" + "'";
    ...
    private void searchTextKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchTextKeyReleased
        ...
        pt = new populateTable();
        sql = "select id,brandName,personName,total,advance,paidAmt,remainingamt,refId,orderDate from companyorders where (refId like'" + search + "%'  or total like '" + search + "%' or companyName like '" + search + "%' or brandName like '" + search + "%' or personName like '" + search + "%') AND paymentStatus='" + "null" + "'";
        pt.searchData(jTable1, sql);
        search = "";
        pt = null;
        sql = "";
