...
import middle.docs.printQuotationNc;
import middle.nc.orderncMiddle;
...
public class quotationncClient extends javax.swing.JFrame {
   ...
   String advance,color,paper;
    ...
    private void initComponents() {
        ...
        jLabel8.setBounds(70, 133, 105, 17);
        ...
        pnameText.setBounds(402, 133, 126, 21);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("COLOR");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(70, 184, 50, 17);

        colorText.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        getContentPane().add(colorText);
        colorText.setBounds(402, 184, 126, 21);

        paperText.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        jButton1.setBounds(910, 300, 210, 63);
        ...
        jButton2.setBounds(910, 410, 210, 63);
        ...
        jButton3.setBounds(930, 180, 191, 31);
        ...
        jButton5.setBounds(1120, 10, 61, 60);
 ...
 public void x() {
    ...
    private void loadCompany() {
        ...
        try {
            String load = "SELECT name FROM ncregister";

            pst = con.prepareStatement(load);
            rs = pst.executeQuery();

            while (rs.next()) {
                pnameText.addItem(rs.getString("name"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String total = String.valueOf(Double.parseDouble(quantity) * Double.parseDouble(rate));
        totalText.setText(total);
        onm.placeOrder(itemName, pName, color, paper, quantity, rate, total,advance);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     //      public static void setReceipt(String comname, String quantity, String refid, String pname, String paper, String color, String rate) {

        String total = String.valueOf(Double.parseDouble(quantity) * Double.parseDouble(rate));
        totalText.setText(total);
        printQuotationNc nc=new printQuotationNc();
       nc.setReceipt(pName,quantity,itemName,paper,color,rate);
